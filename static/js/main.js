...
getInputPass.addEventListener('keyup',() => {let validPass = getInputPass.value;let i = 0;
...
getInputPass2.addEventListener('keyup', () => {let validPass = getInputPass.value;let validPass2 = getInputPass2.value;
